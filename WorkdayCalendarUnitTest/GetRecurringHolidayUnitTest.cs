...
{
    internal class GetRecurringHolidayUnitTest
    {
        ...
        public void SetUp()
        {
            ...
            var mockRecurringHolidays = new List<Holiday>
            {
                ...
                new Holiday { Id = Guid.NewGuid(), Name = "New Year", IsRecurring = true, Date = new DateTime(2026, 1, 1) }
            };

            _mockHolidayService = new Mock<IHolidayService>();
            _mockHolidayService.Setup(service => service.GetRecurringHolidaysAsync()).ReturnsAsync(mockRecurringHolidays);
        ...
        [Test]
        public async Task GetRecurringHolidays_ReturnsResult_WhenHolidaysExist()
        {
