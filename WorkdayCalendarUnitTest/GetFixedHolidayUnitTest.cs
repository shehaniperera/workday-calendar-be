...
{
    internal class GetFixedHolidayUnitTest
    {
        ...
        public void SetUp()
        {
            ...
            {
                new Holiday { Id = Guid.NewGuid(), Name = "Christmas", IsRecurring = false, Date = new DateTime(2025, 12, 25) },
            ...
            _mockHolidayService.Setup(service => service.GetFixedHolidaysAsync()).ReturnsAsync(mockRecurringHolidays);
        ...
        [Test]
        public async Task GetFixedHolidays_ReturnsResult_WhenHolidaysExist()
        {
